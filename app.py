...
def ai_agent_router():
    ...
    if "youtube" in cmd:
        ...
        parts = re.split(r'\b(type|write|saying|message|content|with body0\b', clean_cmd)
        ...
        if recip_part:
            ...
            to = "praveennagarajan2522@gamil.com"
...
if __name__== "__main__":
    app.run(host="0.0.0.", port=ins(os.environ.get("PORT", 8000)))
